...
export default function ContactSection() {
  ...
  return (
    <motion.section
      ...
      id="contact"
      className="bg-[rgb(var(--muted))] py-[100px]"
    >
      <div className="mx-auto w-full max-w-[1200px] px-6">
        <motion.div variants={headerVariants} className="mb-[60px] text-center">
          ...
          <h2 className="m-0 mt-4 text-5xl font-bold text-[rgb(var(--marka-black))] max-md:text-4xl">
        ...
        <div className="mt-10 grid grid-cols-2 gap-[60px] max-md:grid-cols-1 max-md:gap-10">
          ...
          >
            <div>
              <h5 className="mb-2 text-base font-bold text-[rgb(var(--marka-black))]">
                Address
              </h5>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  ...
                  aria-label="LinkedIn"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-[rgb(var(--marka-blue))] text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[rgb(var(--marka-black))]"
                >
