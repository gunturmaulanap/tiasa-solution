        ...
        <div className="mx-auto w-full max-w-[1200px] px-6">
          ...
          >
            ...
            <p className="text-[#64748B] max-w-2xl text-base md:text-lg mx-auto">
              Kami menggabungkan keahlian teknis mendalam dengan pemahaman
              bisnis untuk menghadirkan sistem digital yang presisi.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6 lg:gap-8 mb-14 md:mb-18 lg:mb-24">
            {valueProps.map((prop, index) => (
              <motion.div
                ...
                className="group rounded-2xl bg-white p-6 md:p-8 lg:p-10 text-center transition-shadow duration-300 hover:shadow-xl border border-zinc-100"
              >
                <div className="mb-8 inline-block p-5 rounded-2xl bg-zinc-50 text-[rgb(var(--marka-blue))] group-hover:bg-[rgb(var(--marka-blue))] group-hover:text-white transition-all duration-300">
                  {prop.icon}
                </div>
                <h4 className="text-xl font-semibold text-[#0F172A] mb-4 uppercase tracking-tight">
                  {prop.title}
                </h4>
